angular.module('probedock.testKeyGeneratorWidget').directive('testKeyGeneratorWidget', function() {
  return {
    ...
    templateUrl: '/templates/widgets/test-key-generator/generator.template.html'
  };
}).controller('TestKeyGeneratorWidgetCtrl', function(api, appStore, auth, orgs, projects, $q, $scope) {
