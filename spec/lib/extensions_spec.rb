...
describe Time do
  ...
  describe "#to_ms" do
    ...
    it "should return the number of milliseconds since the epoch", rox: { key: '896d38d5e773' } do
      expect(subject.to_ms).to eq((subject.to_f * 1000).floor)
    end

    it "should floor the value", rox: { key: 'baca0e9b455e' } do
  ...
  describe "#ms_from" do
    ...
    it "should return the difference in milliseconds from another time", rox: { key: 'aa6dc6859ed0' } do
    ...
    it "should round the value", rox: { key: '4a119e0b108b' } do
