...
describe 'API routing' do
  ...
  it(nil, rox: { key: '12a97fdaca46' }){ should route(:post, '/api/test_payloads').to(controller: 'api/test_payloads', action: :create) }
  it(nil, rox: { key: '4a003aabf324' }){ should route(:get, '/api/test_payloads/42').to(controller: 'api/test_payloads', action: :show, id: '42') }
  it(nil, rox: { key: '4d9d38d044c3' }){ should route(:get, '/api/test_results/42').to(controller: 'api/test_results', action: :show, id: '42') }
  it(nil, rox: { key: 'b32a2d48e495' }){ should route(:get, '/api/test_runs').to(controller: 'api/test_runs', action: :index) }
  it(nil, rox: { key: '33adcc1d02dc' }){ should route(:get, '/api/tests').to(controller: 'api/tests', action: :index) }
  it(nil, rox: { key: '2e12d8ee3818' }){ should route(:get, '/api/tests/42/results').to(controller: 'api/tests', action: :results, id: '42') }
