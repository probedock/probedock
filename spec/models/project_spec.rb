...
describe Project do
  ...
  describe "validations" do
    ...
    it(nil, probe_dock: { key: '38a831c819f7' }){ should validate_length_of(:name).is_at_most(255) }
    it(nil, probe_dock: { key: 'e141c38281c5' }){ should validate_presence_of(:url_token) }
    it(nil, probe_dock: { key: '67b690e62453' }){ should validate_length_of(:url_token).is_at_most(25) }
