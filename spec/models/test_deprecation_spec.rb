...
describe TestDeprecation, rox: { tags: :unit } do
  ...
  context "associations" do
    ...
    it(nil, rox: { key: 'a2865228be7a' }){ should belong_to(:category) }
  ...
  context "database table" do
    ...
    it(nil, rox: { key: 'fd045a93d46b' }){ should have_db_column(:category_id).of_type(:integer).with_options(null: true) }
